 ...
 * relacionada con una propiedad que tiene definida una lista dinámica de
 * posibles valores.<br>
 ...
 * 
 */
public class DynamicListPropertyPanel extends PropertyPanel {

	/**
	 * UID por defecto.
	 */
	private static final long serialVersionUID = 5555838933256774038L;
	 ...
	 *            adicional.
	 */
	public DynamicListPropertyPanel(String id,
		...
		// construye la lista.
		DropDownChoice<String> list = new DropDownChoice<String>("dynamicList",
		...
		// componente.
		FeedbackLabel feedbackLabel = new FeedbackLabel("dynamicListFeedback",
				list);
