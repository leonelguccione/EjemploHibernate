 ...
 * 
 */
public class ProjectDTODataProvider extends SortableDataProvider<ProjectDTO> {

	/**
	 * UID por defecto para la serialización.
	 */
	private static final long serialVersionUID = 3153168640053936687L;
	 ...
	 * 
	 */
	public ProjectDTODataProvider(String aColumnName, String anOrdering) {
	...
	public int size() {
		...
		try {
			return this.getProjectsService().getProjectsCount();
