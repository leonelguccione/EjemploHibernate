...
/**
 * Esta excepción puede ser lanzada cuando se busca un grupo de prioridades por
 * un nombre que no existe.
 * 
 * @author Javier Bazzocco javier.bazzocco@zinbig.com
 * 
 */
public class PrioritySetUnknownException extends Exception {

	/**
	 * UID por defecto para la serialización.
	 */
	private static final long serialVersionUID = -5236527053582655092L;
