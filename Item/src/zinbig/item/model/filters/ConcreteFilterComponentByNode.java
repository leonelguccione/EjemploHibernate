 ...
 * filtro de ítems que filtra de acuerdo a su nodo de workflow.
 * 
 * @author Javier Bazzocco javier.bazzocco@gmail.com
 * 
 */
public class ConcreteFilterComponentByNode extends FilterComponentByNode {
	...
	/**
	 * Representa la colección de títulos de nodos de workflow por los que hay
	 * que filtrar.
	 */
	 ...
	 * 
	 * @param someTitles
	 *            es la colección que contiene los títulos de los nodos de
	 *            workflow por los cuales se debe filtrar.
	 * @param mustNegate
	 *            establece si se debe negar o no la condición de este filtro.
	 */
	public ConcreteFilterComponentByNode(Collection<String> someTitles,
			boolean mustNegate) {
	...
	public String getFilterString(FilterStringCreationStrategy aStrategy,
		...
		return aStrategy.getFilterStringForConcreteFilterComponentByNode(this
				.getTitles(), this.isNegated());
	}

	/**
	 * Getter.
	 * 
	 * @return los títulos de los nodos de workflow por los que se debe filtrar.
	 */
	 ...
	 * 
	 * @param someTitles
	 *            son los títulos de los nodos de workflow por los que se debe
	 *            filtrar.
	 */
