...
/**
 * Las inatsncias de esta clase se utilizan para persistir tipos definidos por
 * el usuario, en particular tipos enumerativos.
 * 
...
public class GenericEnumUserType implements UserType, ParameterizedType {
	...
	public Object nullSafeGet(ResultSet rs, String[] names, Object owner)
		...
		try {
			...
			valueOfMethod.invoke(enumClass, new Object[] { identifier });
